 ...
 */
final class Version20220220185830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE source source LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE produit CHANGE description2 description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD description2 LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP description, CHANGE nom nom VARCHAR(60) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE interprete interprete VARCHAR(70) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
