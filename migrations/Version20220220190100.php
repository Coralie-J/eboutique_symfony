 ...
 */
final class Version20220220190100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media DROP INDEX IDX_6A2CA10CAABEFE2C, ADD UNIQUE INDEX UNIQ_6A2CA10CAABEFE2C (id_produit_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media DROP INDEX UNIQ_6A2CA10CAABEFE2C, ADD INDEX IDX_6A2CA10CAABEFE2C (id_produit_id)');
